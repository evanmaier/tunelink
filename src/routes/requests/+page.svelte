...
<AuthCheck>
	<div class="flex flex-col h-[calc(100vh-4rem)]">
		<h2 class="text-2xl font-bold text-center p-6">Rentals</h2>

		<div class="grid grid-cols-3 gap-10 flex-1 p-4">
			<div class="flex flex-col gap-5 shadow-md rounded-lg p-2 w-full h-full overflow-y-auto">
